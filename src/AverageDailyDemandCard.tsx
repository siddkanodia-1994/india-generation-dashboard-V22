    ...
    <div className="mt-6 bg-white rounded-2xl shadow-sm ring-1 ring-slate-200">
      ...
      <div className="p-4">
        ...
        <div className="mt-3 space-y-0.5 text-[11px] text-slate-500">
          ...
          <div>Total PLF% = Total Avg Daily GW ÷ Rated Capacity total (Installed × (1−Maint%) × PLF%) × 100. PLF%, capacity, and maintenance values are editable and saved in your browser (shared with Demand Source tab).</div>
